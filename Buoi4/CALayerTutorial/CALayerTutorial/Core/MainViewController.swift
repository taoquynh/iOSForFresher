    ...
    func setupData(){
        sections = [
            Section(title: "Shadow",
                    menu: [
                        Menu(title: "Default Shadows", identifier: "DefaultShadowsViewController"),
                        Menu(title: "Contact Shadow", identifier: "ContactShadowViewController"),
                        Menu(title: "Depth Shadow", identifier: "DepthShadowViewController"),
                        Menu(title: "Flat And Long Shadow", identifier: "FlatAndLongShadowViewController"),
                        Menu(title: "Curved Shadow", identifier: "CurvedShadowViewController"),
                        Menu(title: "Double Stroke", identifier: "DoubleStrokeViewController")
                        ]),
            Section(title: "Shape Path",
                    menu: [
                        Menu(title: "Shape path", identifier: "ShapePathViewController")
                ])
        ]
    }
}
