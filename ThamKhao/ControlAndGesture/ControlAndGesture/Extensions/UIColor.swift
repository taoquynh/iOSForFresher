...
@objc extension UIColor {
    class func mainPink()-> UIColor{
        return UIColor(red:0.96, green:0.18, blue:0.34, alpha:1)
    }
    class func mainGreen()-> UIColor{
        return UIColor(red:0.42, green:0.62, blue:0.22, alpha:1)
    }
    class func mainPurple()-> UIColor{
        return UIColor(red:0.32, green:0.18, blue:0.54, alpha:1)
    }
